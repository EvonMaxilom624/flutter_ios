...
class DegreeProgramPageDev extends StatefulWidget {
  const DegreeProgramPageDev({super.key});

  @override
  State<DegreeProgramPageDev> createState() => _DegreeProgramPageDevState();
}

class _DegreeProgramPageDevState extends State<DegreeProgramPageDev> {
